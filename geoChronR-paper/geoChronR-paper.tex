...
\includegraphics{geoChronR-paper_files/figure-latex/unnamed-chunk-2-1.pdf}
...
The results show consistently negative correlations, although 20.26\% of
the ensemble members are positive. However, only 0.62\% are significant
...
\begin{figure}
\includegraphics[width=8.3cm]{Nikolaus_Kopernikus} \caption{one column figure}\label{fig:unnamed-chunk-9}
\end{figure}
...
\begin{figure}
\includegraphics[width=12cm]{Nikolaus_Kopernikus} \caption{two column figure}\label{fig:unnamed-chunk-10}
\end{figure}
