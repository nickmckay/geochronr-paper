...
Flagstaff, AZ 86011}
\affil[2]{Department of Earth Sciences, University of Southern California, Los
Angeles, CA, 90089}
...
\codeavailability{All of the code used in geoChronR is open and available at
https://github.com/nickmckay/geochronr, and we welcome contributions and
extensions to the package. The Rmarkdown code used to create this
manuscript is available at https://github.com/nickmckay/geochronr-paper.} %% use this section when having only software code available

\dataavailability{All of the data used in this paper are publicly archived, and available
as LiPD files at http://lipdverse.org/geoChronR-examples/.} %% use this section when having only data sets available
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\disclaimer{The software described here is provided under the MIT License, and is
...
dealings in the software.} %% optional section

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{acknowledgements}
This project was funded by the US National Science Foundation
Geoinformatics Program (EAR-1347221). We thank the participants of the
2016 and 2017 geoChronR workshops for their contributions to the testing
and design, which dramatically improved this package.
