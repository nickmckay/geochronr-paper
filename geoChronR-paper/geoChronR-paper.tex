...
The similarity between these datasets (and other GrIndeed, \citet{hulu2001} argue that the the similarity hasso much so that the well-dated Hulu Cave record has been used to support the independent chronology of GISP2 \citep{hulu2001}.
...
Further, only 0\% are significant after accounting for serial correlation.
Given the age models and correlation parameters used here, would would therefore conclude that the two series are not significantly correlated.
