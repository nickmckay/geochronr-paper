...
\begin{figure}
\includegraphics[width=12cm]{geoChronR-paper_files/figure-latex/MTM ensemble export-1} \caption{MTM spectrum for IODP 846, 1000-member age ensemble}(\#fig:MTM ensemble export)
\end{figure}
