...
2. Refining our understanding of how past changes in the Earth system impact the age accuracy, for example: improvements to the radiocarbon calibration curve [@intcal13;@intcal20] and advances in our understanding of spatial variability in cosmogenic production rates used in exposure dating [@Balco2009;@Masarik2009;@charreau2019basinga].
...
GeoChronR's function `gaussianize` allows users to transform each series to normality using the inverse Rosenblatt transform [@vanAlbada2007].
Many analytical methods assume normality, and in GeoChronR, all four of the major toolsets will optionally `gaussianize` the data prior to analysis.
