...
Correlating the two age-uncertain datasets will characterize the relationship, but ignores additional information such as spectral periodicities, climate forcings, and replication in regional datasets that may support a mechanistic relationship between two timeseries.
However, it does provide insight into how age uncertainty can affect apparent alignment between two datasets.
