...
```{r age-model,echo = FALSE,warning=FALSE,message = FALSE,fig.cap = "Need to write a caption"}
print(chronPlot)
```
...
```{r timeseries,echo = FALSE,warning=FALSE,message = FALSE,fig.cap = "Need to write a caption"}
...
```{r cor-hist,echo = FALSE,warning=FALSE,message = FALSE,fig.cap = "Need to write a caption"}
...
`plotRegressEns` produces a number of individual plots that show the results of an age-uncertain regression, and additionally creates an overview "dashboard" that showcases the key results (figure \@ref(fig:regression)).
...
```{r regression,echo = FALSE,warning=FALSE,message = FALSE,fig.cap = "Need to write a caption"}
