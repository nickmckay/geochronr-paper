...
Following binning, Pearson correlation is calculated and recorded for each ensemble member. Their significance is then established using three approaches. A principal difficulty in doing so is that paleogeoscientific timeseries are often highly autocorrelated, which can lead to spurious assessments of significance [@Hu_epsl17]. 
...
corout <- corEns(gisp2.ens,gisp2.d18O,hulu.ae,hulu.d18O,bin.step = 200,max.ens = 10000,calculate.isopersistence = TRUE)
