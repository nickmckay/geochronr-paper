...
## Integrated geochronology uncertainty quantification software
...
### Banded Age Models (BAM)


## Age-uncertain analytical tools
...
In this use case, we demonstrate how a user could calculate and visualize and age-uncertain correlation between the Hulu speleothem d18O record and the GISP2 ice core record. (Introduction about why a user might want to do an age uncertain correlation between Hulu and GISP2). 
