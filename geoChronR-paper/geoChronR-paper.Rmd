...
2. {isopersistence} (Julien your input here would be great)
...
As mentioned above, there are many reasons to believe that there are teleconnections that link Greenland temperatures to the dynamics monsoon circulation in Asia, especially during abrupt climate changes during glacial periods [e.g. @liu2013links;@duan2016onset;@zhang2019asian
].
...
Generally, age uncertainties obscure relationships between records, while in some cases creating the appearance of spurious correlations. 
